...
import heroImg from "../public/img/ley.jpg";
// import CV from "../public/img/menu.f6b29611.png";
const menu = "/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fmuestra.ac0684b1.png&w=1080&q=100"
    ...
    <>
      <Container className="flex flex-wrap ">
        <div className="flex items-center w-full lg:w-1/2">
          <div className="px-5 max-w-2xl mb-8">
            <h1 className="text-4xl font-bold leading-snug tracking-tight text-gray-800 lg:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight dark:text-white">
              Nombre de tu Negocio
            </h1>
            <p className="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300">
              Eslogan o descripcion de tu negocio
            </p>
            ...
            <p className="py-5 text-m leading-normal text-red-500 lg:text-m m:text-2xl dark:text-red-600">
              Insertamos una imagen descargable en tu sitio
            </p>
          </div>
        </div>
        <div className="flex items-center justify-center w-full lg:w-1/2">
          <div className="">
            <Image
              ...
              placeholder="blur"
            />
            <p className="py-5 text-xs leading-normal text-gray-500 lg:text-xs xs:text-2xl dark:text-gray-300">
              Aplican terminos y condiciones. Valido hasta el 1 de Septiembre del 2023
            </p>
            <p className="py-5 text-m leading-normal text-red-500 lg:text-m m:text-2xl dark:text-red-600">
              Añadir el logotipo de tu negocio o una imagen promocional genera más visibilidad
            </p>
          </div>
        </div>
      </Container>
      <Container>
        <div className="flex flex-col justify-center">
          <div className="text-xl text-center text-gray-700 dark:text-white">
            Nuestros clientes <span className="text-indigo-600">45+</span>{" "}
            en todo el mundo
          </div>
